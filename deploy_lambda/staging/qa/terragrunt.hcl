...
inputs = {
  ...
  lambda_functions = {
    ...
    qa-ap-l1t-update-status = {
      ...
      environment   = {
        JOB_PASSWORD  = "AQICAHhX5Bu6JxI4nOyGjWm4KardO68/V4xoaB69qB4ug8FZlgHw/Scn0sqToou4YbKVbmNXAAAAfjB8BgkqhkiG9w0BBwagbzBtAgEAMGgGCSqGSIb3DQEHATAeBglghkgBZQMEAS4wEQQMF9oCIx5jUANwYmn2AgEQgDuzXWdPcgus17ZnMGPwFhEE65pIpmO0GBHLOSnmRldmdMXCWrYWC/Kk5xISQR+nWeA/0MGghJV9V1QqZw=="
        JOB_USERNAME  = "AQICAHhX5Bu6JxI4nOyGjWm4KardO68/V4xoaB69qB4ug8FZlgG0XCZ8mgt8mH12coEIwsU0AAAAdDByBgkqhkiG9w0BBwagZTBjAgEAMF4GCSqGSIb3DQEHATAeBglghkgBZQMEAS4wEQQM389QfpIXkdVbJcQRAgEQgDEkIsF94mdHjll9vUC3KigiA55WhnMHSWfm/1xe5PEtpfoXbBYYdZUTbogmbykdRqPf"
      }
      is_monitoring_enabled = false
      vpc_config = {
        subnet_ids = "app"
    ...
    qa-ap-l1t-update-licence-status-job = {
      description = "Repository: molb-agency-portal-backend"
      architectures = ["x86_64"]
      ...
      environment   = {
        JOB_METHOD    = "POST"
        JOB_PASSWORD  = "AQICAHhX5Bu6JxI4nOyGjWm4KardO68/V4xoaB69qB4ug8FZlgHw/Scn0sqToou4YbKVbmNXAAAAfjB8BgkqhkiG9w0BBwagbzBtAgEAMGgGCSqGSIb3DQEHATAeBglghkgBZQMEAS4wEQQMF9oCIx5jUANwYmn2AgEQgDuzXWdPcgus17ZnMGPwFhEE65pIpmO0GBHLOSnmRldmdMXCWrYWC/Kk5xISQR+nWeA/0MGghJV9V1QqZw=="
        JOB_URL       = "https://api.agencyportal.qa.gobusiness.io/job/cron/update-licence-status"
        JOB_USERNAME  = "AQICAHhX5Bu6JxI4nOyGjWm4KardO68/V4xoaB69qB4ug8FZlgG0XCZ8mgt8mH12coEIwsU0AAAAdDByBgkqhkiG9w0BBwagZTBjAgEAMF4GCSqGSIb3DQEHATAeBglghkgBZQMEAS4wEQQM389QfpIXkdVbJcQRAgEQgDEkIsF94mdHjll9vUC3KigiA55WhnMHSWfm/1xe5PEtpfoXbBYYdZUTbogmbykdRqPf"
      }
      is_monitoring_enabled = false
      vpc_config = {
  ...
  sqs_triggers = {
    approval-workflow = {
      sqs_name             = "qa-ap-start-approval-workflow"
      lambda_function_name = "qa-ap-start-approval-workflow"
      batch_size           = 10
    }
    l1t-update-status = {
      sqs_name             = "qa-ap-l1t-update-status"
      lambda_function_name = "qa-ap-l1t-update-status"
      batch_size           = 1
    }
  }
  ...
  eventbridge_cron_triggers = {
    l1t-update_licence_status_job = {
      name                 = "qa-ap-l1t-update-licence-status-job"
      lambda_function_name = "qa-ap-l1t-update-licence-status-job"
